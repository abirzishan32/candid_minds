...
const Page = async () => {
    ...
    // parallel calling userInterviews (interviews only for the user) and latest interviews (all interviews generated by others)
            ...
            <section className="card-cta">
                <div className="flex flex-col gap-6 max-w-lg">
                    ...
                    <Button asChild className="btn btn-primary max-sm:w-full">
                        <Link href="/interview-main"> Start an Interview </Link>
                    </Button>
                </div>
