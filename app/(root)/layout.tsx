                ...
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    <div className="flex items-center gap-6">
                        ...
                        <div className="hidden md:flex items-center gap-7">
                            ...
                            <NavLink href="/resume-checker" label="Resume Checker" />
                            <NavLink href="/job-market" label="Job Market Insights" />
                            {isModerator && (
                                <NavLink href="/moderator-dashboard" label="Moderator Dashboard" />
                            )}
                        </div>
                    </div>
                    ...
                    >
                        ...
                        >
                            <div className="flex flex-col gap-6">
                                ...
                                <MobileNavLink href="/resume-checker" label="Resume Checker" onClick={() => setIsMenuOpen(false)} />
                                ...
                                {/* Decorative elements */}
                                <div className="absolute bottom-12 left-6 h-40 w-40 rounded-full bg-blue-600/10 blur-3xl"></div>
                                <div className="absolute top-40 right-6 h-24 w-24 rounded-full bg-primary-100/10 blur-2xl"></div>
                            </div>
                        </motion.div>
                    </motion.div>
                )}
